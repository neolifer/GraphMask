...
from codes.abstract.abstract_torch_module import AbstractTorchModule
from codes.gnns.srl_gcn import SrlGcn
from codes.problems.srl import srl_utils
from codes.problems.srl.srl_utils import parse_word_embeddings, constrained_decoder
from codes.problems.srl.voc import create_voc
from codes.utils.evaluation.srl_model_output import SrlModelOutput
from codes.utils.pad import pad_to_max
import numpy as np

from codes.utils.torch_utils.gnn_utils import add_backwards_edges
...
class SrlModel(AbstractTorchModule):
    ...
    def forward(self, batch):
        ...
        for i, length in enumerate(sentence_lengths):
            ...
            best_labeling = constrained_decodesr(local_role_vocabulary, example_predictions, 100, [])
